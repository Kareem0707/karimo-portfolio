...
const MarqueeSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // window.scrollY - sectionTop + window.innerHeight equivalent can be derived:
  ...
  // Tripling the images for seamless scrolling
  ...
  return (
    <section ref={sectionRef} className="bg-[#0C0C0C] pt-24 sm:pt-32 md:pt-40 pb-10 overflow-hidden flex flex-col gap-3">
      {/* Row 1 - Moves Right */}
      <div className="flex gap-3 w-max" style={row1Styles}>
        {renderRow(ROW_1_IMAGES)}
      </div>
      
      {/* Row 2 - Moves Left */}
      <div className="flex gap-3 w-max" style={row2Styles}>
        {renderRow(ROW_2_IMAGES)}
      </div>
    </section>
  );
};
